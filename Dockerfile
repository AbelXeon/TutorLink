...
CMD php artisan storage:link --force && php artisan config:clear && php artisan migrate --seed --force && /usr/bin/supervisord -c /etc/supervisor/conf.d/supervisord.conf