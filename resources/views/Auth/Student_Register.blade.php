...
<head>
    ...
    <meta name="description" content="Register as a student on TutorLink. Connect with verified academic and programming tutors across Ethiopia and start learning today.">
...
<div class="lg:grid lg:grid-cols-2">
    ...
    <div class="story-panel hidden lg:flex lg:flex-col lg:justify-between p-12 xl:p-16">
        ...
        <div class="story-content">
            <p class="text-xs uppercase tracking-widest" style="color:#7d92c9;">TutorLink / Students</p>
            <h1 class="display-font text-white mt-3" style="font-size: clamp(2.6rem, 4.2vw, 3.6rem); line-height: 0.95;">
                Verified.<br>Flexible.<br><span style="color: var(--blue);">Yours.</span>
            </h1>
            <p class="mt-6 text-sm leading-relaxed" style="color:#b5b5b5; max-width: 34ch;">
                Join a community of learners across Ethiopia connecting with subject-matched, verified tutors — from core academics to programming.
            </p>
        </div>
        ...
        <div class="story-content space-y-5 mt-10">
            <div class="benefit-item flex items-start gap-3">
                ...
                <span class="text-sm text-white">Every tutor profile is reviewed and verified</span>
            </div>
            <div class="benefit-item flex items-start gap-3">
                <svg class="w-5 h-5 shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M9 12l2 2 4-4" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <span class="text-sm text-white">Book a lesson slot directly, in minutes</span>
            </div>
            <div class="benefit-item flex items-start gap-3">
                <svg class="w-5 h-5 shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M9 12l2 2 4-4" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <span class="text-sm text-white">Subjects ranging from academics to code</span>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-xl w-full">
        ...
        <div class="mb-8">
            ...
            <h2 class="display-font text-3xl text-gray-900 mt-1">Register as a Student</h2>
        </div>
        ...
        <form class="space-y-5" action="{{ route('register.student') }}" method="POST">
            @csrf
    ...
    <!-- Password show/hide toggles + live strength meter + confirm-match check.
         Purely front-end UX additions: field names/values/ids used for submission
         are untouched, so nothing about what's sent to the server changes. -->
    <script>
        (function () {
