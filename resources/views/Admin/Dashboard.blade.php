...
<body class="min-h-screen flex font-sans antialiased" style="background: var(--paper); color: var(--ink);">

    <!-- SIDEBAR NAVIGATION -->
    <aside class="w-64 flex flex-col justify-between shrink-0" style="background: var(--ink); border-right: 1px solid rgba(255,255,255,0.08);">
        <div class="p-6">
            <!-- Brand Header -->
            ...
            <nav class="space-y-1.5">
                <button type="button" onclick="switchTab('overview')" id="nav-overview" class="nav-link-flat active w-full flex items-center space-x-3 px-4 py-3 text-sm font-semibold">
                ...
                <button type="button" onclick="switchTab('register-admin')" id="nav-register-admin" class="nav-link-flat w-full flex items-center space-x-3 px-4 py-3 text-sm font-semibold">
                ...
                <button type="button" onclick="switchTab('settings')" id="nav-settings" class="nav-link-flat w-full flex items-center space-x-3 px-4 py-3 text-sm font-semibold">
    ...
    <main class="flex-grow p-8 overflow-y-auto max-w-7xl mx-auto w-full">
        ...
        <div id="tab-content-overview" class="space-y-8">
            <div class="pb-6 flex items-center justify-between" style="border-bottom: 1px solid var(--line);">
                <div>
                    <h1 class="text-3xl display-font text-gray-900">System Overview</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Card 1 -->
                <div class="swiss-panel p-6 flex items-center gap-4">
                    ...
                    <div>
                        <span class="block text-2xl display-font text-gray-900">{{ $totalUsers }}</span>
                ...
                <div class="swiss-panel p-6 flex items-center gap-4">
                    ...
                    <div>
                        <span class="block text-2xl display-font text-gray-900">{{ $totalTeachers }}</span>
                ...
                <div class="swiss-panel p-6 flex items-center gap-4">
                    ...
                    <div>
                        <span class="block text-2xl display-font text-gray-900">{{ $totalStudents }}</span>
                ...
                <div class="swiss-panel p-6 flex items-center gap-4">
                    ...
                    <div>
                        <span class="block text-2xl display-font text-gray-900">{{ $totalBookings }}</span>
                ...
                <div class="swiss-panel p-6 flex items-center gap-4">
                    ...
                    <div>
                        <span class="block text-2xl display-font" style="color:#0f8f6f;">{{ $acceptedBookings }}</span>
                ...
                <div class="swiss-panel p-6 flex items-center gap-4">
                    ...
                    <div>
                        <span class="block text-2xl display-font" style="color:#b45309;">{{ $pendingBookings }}</span>
        ...
        <div id="tab-content-register-admin" class="hidden space-y-8">
            <div class="pb-6" style="border-bottom: 1px solid var(--line);">
                <h1 class="text-3xl display-font text-gray-900">Register Administrator</h1>
                <p class="text-sm text-gray-500 mt-1">Create standard subordinate accounts</p>
            </div>

            <div class="swiss-panel p-8 max-w-xl">
                @if ($errors->any())
                ...
                <form action="{{ route('admin.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="pt-4 flex justify-end">
                        <button type="submit" class="btn-swiss-primary py-2.5 px-6 text-xs font-bold text-white">
        ...
        <div id="tab-content-settings" class="hidden space-y-8">
            <div class="pb-6" style="border-bottom: 1px solid var(--line);">
                <h1 class="text-3xl display-font text-gray-900">Administrative Credentials</h1>
            ...
            <div class="swiss-panel p-8 max-w-xl">
                ...
                <div id="settings_wizard_code" class="hidden space-y-6">
                    ...
                    <form id="wizard_code_form" action="{{ route('settings.verify_code') }}" method="POST" class="space-y-4">
                        ...
                        <div class="flex justify-between items-center pt-2">
                            <button type="button" id="wizard_resend_btn" class="text-xs font-bold disabled:text-gray-400 disabled:cursor-not-allowed" style="color: var(--blue);">Resend Code</button>
                ...
                <div id="settings_wizard_username" class="hidden space-y-6">
                    ...
                    <form id="wizard_username_form" action="{{ route('settings.update_username') }}" method="POST" class="space-y-4">
                        ...
                        <div class="pt-2 flex justify-end">
                            <button type="submit" class="btn-swiss-primary py-2.5 px-6 text-xs font-bold text-white">Apply Changes</button>
                        </div>
                    </form>
                </div>
                ...
                <div id="settings_wizard_password" class="hidden space-y-6">
                    ...
                    <form id="wizard_password_form" action="{{ route('settings.update_password') }}" method="POST" class="space-y-4">
                        ...
                        <div class="pt-2 flex justify-end">
                            <button type="submit" class="btn-swiss-primary py-2.5 px-6 text-xs font-bold text-white">Apply New Password</button>
                        </div>
                    </form>
                </div>
